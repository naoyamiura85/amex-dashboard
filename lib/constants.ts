...
// ファネルステージの色定義（サントリーブルー系 - 濃から薄へのグラデーション）
export const FUNNEL_COLORS = {
  search: "#003D82",       // 検索 - サントリーブルー（濃）
  visit: "#0055B8",        // 来訪 - サントリーブルー
  cart: "#0068B7",         // カート - サントリーブルー（中）
  purchase: "#0088CC",     // 購入 - サントリーブルー（淡）
  repeat: "#5DADE2",       // リピート - サントリーブルー（薄）
  lm: "#64748B",           // LM(ポテンシャル小) - グレー
  mh: "#3B82F6",           // MH(ポテンシャル大) - ブルー
  regular: "#0068B7",      // 定期購入 - サントリーブルー
} as const
