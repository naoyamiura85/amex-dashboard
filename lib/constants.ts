...
// ファネルステージの色定義（温かみのあるバランス配色）
export const FUNNEL_COLORS = {
  search: "#6366F1",       // 検索 - インディゴ
  visit: "#8B5CF6",        // 来訪 - パープル
  cart: "#EC4899",         // カート - ピンク
  purchase: "#10B981",     // 購入 - エメラルド
  repeat: "#F59E0B",       // リピート - アンバー
  lm: "#64748B",           // LM(ポテンシャル小) - スレート（グレー）
  mh: "#3B82F6",           // MH(ポテンシャル大) - ブルー
  regular: "#F59E0B",      // 定期購入 - アンバー（ゴールド）
} as const
