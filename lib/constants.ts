...
export const FUNNEL_COLORS = {
  search: "#0068B7",       // 検索 - サントリーブルー
  visit: "#0088CC",        // 来訪 - ライトブルー
  cart: "#00A0E9",         // カート - スカイブルー
  purchase: "#00B894",     // 購入 - ティール
  repeat: "#F5A623",       // リピート - ゴールド
  lm: "#0068B7",           // LM(ポテンシャル小) - サントリーブルー
  mh: "#00A0E9",           // MH(ポテンシャル大) - スカイブルー
  regular: "#F5A623",      // 定期購入 - ゴールド
} as const

// サンキーダイアグラム用グラデーション
export const SANKEY_GRADIENTS = [
  { from: "#0068B7", to: "#0088CC" }, // 検索→来訪
  { from: "#0088CC", to: "#00A0E9" }, // 来訪→カート
  { from: "#00A0E9", to: "#00B894" }, // カート→購入
  { from: "#00B894", to: "#F5A623" }, // 購入→リピート
] as const
